    ...
    public static List<UserMealWithExceed>  getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal meal : mealList) {
            ...
            if (map.containsKey(key)) {
                ...
                map.put(key, oldValue + meal.getCalories());
                continue;
            }
            map.put(key, meal.getCalories());
        }
        ...
        for(UserMeal meal : mealList) {
            ...
            boolean exeded = false;
            if (TimeUtil.isBetween(lt, startTime, endTime)) {
                if (map.get(meal.getDateTime().toLocalDate()) > caloriesPerDay) {
                    exeded = true;
                }
                list.add(new UserMealWithExceed(meal.getDateTime(), meal.getDescription(), meal.getCalories(), exeded));
            }
        }
